...
N个盒子（1~N），盒子$i$中有$A_i$个球，现需使每个盒中球的个数各不相同，盒子里面只能放入不可取出，问题：最少放入多少球，使每个盒子球数各不相同。[LeeCode945](<https://leetcode-cn.com/problems/minimum-increment-to-make-array-unique/>)
...
N个木棍（1~N），第i个木棍长$L_i$，用完所有木棍，拼出正方形，一共T组，有些无解，判断T组是否有解，有YES，无NO。$1\le N\le 20$,$1\le L_i \le 10000$。 [LeeCode473](https://leetcode-cn.com/problems/matchsticks-to-square/)

输入：第一行T，表示有T组测试数据，第二行，第一个是n，表示有n个木根，接下来n个数表示木棍的长度。

输出：有解输出YES，否则输出NO

样例：<br>输入：<br>2<br>5 1 1 2 2 2<br>5 3 3 3 3 4<br>输出：<br>YES<br>NO
